...
public class CircularDrive : MonoBehaviour
{
    ...
    private void Update()
    {
        if (testHand != null)
        {
            HandHoverUpdate(testHand);

            if (Input.GetKeyDown(KeyCode.B))
            {
                testHand.Controller.GetPressDown(Valve.VR.EVRButtonId.k_EButton_SteamVR_Trigger);
                testHand.Controller.GetPress(Valve.VR.EVRButtonId.k_EButton_SteamVR_Trigger);
            }
        }
    }
    ...
    private void HandHoverUpdate(VRInteractor hand)
    {
        ...
        else if (hand.Controller.GetPressUp(Valve.VR.EVRButtonId.k_EButton_SteamVR_Trigger))
        {
        ...
        else if (driving && hand.Controller.GetPress(Valve.VR.EVRButtonId.k_EButton_SteamVR_Trigger))
        {
            ComputeAngle(hand);
            UpdateAll();
        }
    ...
    //-------------------------------------------------
    private void ComputeAngle(VRInteractor hand)
    {
